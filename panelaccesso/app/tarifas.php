...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="tarifas.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <button type="button" class="btn btn-success" style="float: right" data-toggle="modal" data-target="#modal-lg" onclick="CargarVentanaAgregar(2)">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listado de Ubicaciones con Tarifas ya Guardadas</h3>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-head-fixed text-nowrap" id="mytable" name="mytable">
                  <thead >
                    <tr style="text-align: center; color: white;">
                      ...
                      <th style="background-color: #01A9DB;">Destino</th>
                      <th style="background-color: #01A9DB;"></th>
                    </tr>
                  </thead>
                  <tbody id="tabla">
...
<script src="../dist/js/demo.js"></script>
   ...
   <script type="text/javascript">
    ...
    function EliminarTarifas(opcion,id)
      {
      ...
      function Guardar_Tarifa(opcion,id)
      {
        
        if (opcion == 1) {
          var e = document.getElementById("ubi");
          var ubi = e.options[e.selectedIndex].value; 
        }
        if (opcion == 2) {
          var ubi = document.getElementById("ubi2").value;
        }

        val =2;
       
        var one = $("input[name='one[]']")
              .map(function(){return $(this).val();}).get();
        
        var ret = $("input[name='ret[]']")
              .map(function(){return $(this).val();}).get();
        var id_ida = $("input[name='id_ruta[]']")
              .map(function(){return $(this).val();}).get();

        var id_ret = $("input[name='id_retorno[]']")
              .map(function(){return $(this).val();}).get();
       
        $.ajax({
                data: "opc="+val+"&one="+one+"&ret="+ret+"&id="+id+"&ubicacion="+ubi+"&ida="+id_ida+"&id_ret="+id_ret,
                type: "POST",
