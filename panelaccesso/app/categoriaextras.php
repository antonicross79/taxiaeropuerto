...
<head>
  ...
  <title>AdminLTE 3 | Grupos de extras</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Grupos de extras</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="menu.php">Home</a></li>
              <li class="breadcrumb-item"><a href="extras.php">Extras</a></li>
              <li class="breadcrumb-item active">Grupos de extras</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <button type="button" class="btn btn-success" style="float: right" data-toggle="modal" data-target="#modal-lg" onclick="CargarVentanaAgregar(8)">
                ...
                <table class="table table-head-fixed text-nowrap" id="mytable" name="mytable">
                  <thead >
                    <tr style="text-align: center; color: white;">
                      ...
                      <th style="background-color: #01A9DB;">Nombre Grupo</th>
                      <th style="background-color: #01A9DB;"></th>
                    </tr>
                  </thead>
                  <tbody id="tabla">
...
<script src="../dist/js/demo.js"></script>
   ...
   <script type="text/javascript">
      ...
      function Guardar_Categoria(opcion,id)
      {
        var nombre = document.getElementById("nombre").value;
        $.ajax({
                data: "opc="+10+"&id="+id+"&nombre="+nombre,
                type: "POST",
