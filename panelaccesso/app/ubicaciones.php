...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="ubicaciones.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <button type="button" class="btn btn-success" style="float: right" data-toggle="modal" data-target="#modal-lg" onclick="CargarVentanaAgregar(3)">
                ...
                <table class="table table-head-fixed text-nowrap" id="mytable" name="mytable">
                  <thead >
                    <tr style="text-align: center; color: white;">
                      ...
                      <th style="background-color: #01A9DB;">Nombre Ubicacion</th>
                      <th style="background-color: #01A9DB;"></th>
                    </tr>
                  </thead>
                  <tbody id="tabla">
...
<script src="../dist/js/demo.js"></script>
   ...
   <script type="text/javascript">
      ...
      function EliminarUbicacion(opcion,id)
      {
      ...
      function Guardar_Ubicacion(opcion,id)
      {
        
        
        var ubi = document.getElementById("n_ubicacion").value;
      
    
        $.ajax({
                data: "opc="+opcion+"&id="+id+"&ubicacion="+ubi,
                type: "POST",
