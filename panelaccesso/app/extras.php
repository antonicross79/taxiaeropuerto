...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="extras.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <a class="btn btn-primary" style="float:right;margin-left:10px;" href="categoriaextras.php">Grupo de extras</a>
        <button type="button" class="btn btn-success" style="float: right" data-toggle="modal" data-target="#modal-lg" onclick="CargarVentanaAgregar(7)">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listado de Extras</h3>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-head-fixed text-nowrap" id="mytable" name="mytable">
                  <thead >
                    <tr style="text-align: center; color: white;">
                      ...
                      <th style="background-color: #01A9DB;">Nombre Extra</th>
                      <th style="background-color: #01A9DB;">Descripción</th>
                      <th style="background-color: #01A9DB;">Grupo</th>
                      <th style="background-color: #01A9DB;">Imagen</th>
                      <th style="background-color: #01A9DB;">Precio</th>
                      <th style="background-color: #01A9DB;"></th>
                    </tr>
                  </thead>
                  <tbody id="tabla">
...
<script src="../dist/js/demo.js"></script>
   ...
   <script type="text/javascript">
      ...
      function Guardar_Transfer(opcion,id)
      {
        ...
        var nombre_extra = document.getElementById("n_extra").value;
        var descripcion = document.getElementById("descri_extra").value;
        var precio = document.getElementById("precio_extra").value;
        var categoria = document.getElementById("categoria").value;
        $.ajax({
                data: "opc="+opcion+"&id="+id+"&n_extra="+nombre_extra+"&descri_extra="+descripcion+"&precio_extra="+precio+"&categoria="+categoria,
                type: "POST",
