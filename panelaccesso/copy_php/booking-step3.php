...
$row = mysqli_fetch_array($respuesta);
    ...
    $contenido_correo.= "<img src='https://taxiaeropuertodecancun.com/images/getshuttlecancun.png' style='width:35%;'><br>";
    $contenido_correo.= "<img src='https://taxiaeropuertodecancun.com/images/logo_correo2.png'><br><br>";
	$contenido_correo.= "<h2><strong> INGLES <strong></h2><br><br>";
	$contenido_correo.= "<p>taxiaeropuertodecancun appreciates your preference to provide your transportation services in Cancun and the Riviera Maya with us.</p><br>";
    ...
    $contenido_correo.= "<h2><strong> ESPA05OL <strong></h2><br><br>";
	$contenido_correo.= "<p>taxiaeropuertodecancun agradece su preferencia para proveerle sus servicios de transportaci¨®n en Canc¨²n y la Riviera Maya nosotros.</p><br>";
	$contenido_correo.= "<p>A continuaci¨®n, encontrar¨¢ los detalles de su reservaci¨®n. Si alguna informaci¨®n NO es correcta, comun¨ªquese con nosotros de inmediato con las correcciones de sus datos al correo reservation@getshuttlecancun.com anotando en ASUNTO: (N¨²mero de Reserva). </p><br>";
	$contenido_correo.= "<p>A continuaci¨®n, encontrar¨¢ los detalles de su reservaci¨®n. Si alguna informaci¨®n NO es correcta, comun¨ªquese con nosotros de inmediato con las correcciones. A la brevedad le llegar¨¢ un correo con las instrucciones de punto de encuentro a su llegada a la terminal para hacer m¨¢s r¨¢pido y segura nuestro encuentro.</p><br>";

    $contenido_correo.= "<p style='text-align:center;'><strong>Por favor de presentar este voucher impreso o digital en su tel¨¦fono y presentarlo a nuestro representante en el aeropuerto.</strong></p><br>";
	...
	$contenido_correo.= "Codigo TransacciÃ³n Paypal:  ".$row['transaccion_paypal']."<br><br>";
	$contenido_correo.= "Codigo TransacciÃ³n Paypal:  ".$row['transaccion_paypal']."<br><br>";
	if(count($extras) > 0){
	...
	$contenido_correo.= "<p>Estaremos encantados de brindarle informaci¨®n adicional sobre servicios y actividades que puede realizar en Canc¨²n y la Riviera Maya.</p><br>";
	$contenido_correo.= "<p>La reserva ha sido Completada, puede cancelar su reserva hasta 24 horas antes de su llegada.</p><br>";
	$contenido_correo.= "<p>Si por alg¨²n motivo, hace un cambio de vuelo y horario, o le es cancelado su vuelo por la aerol¨ªnea, le respetaremos la reserva para ese otro vuelo u otro d¨ªa, siempre y cuando nos notifique dicho cambio inmediatamente al correo reservation@getshuttlecancun.com anotando en ASUNTO: (N¨²mero de Reserva).</p><br>";
	$contenido_correo.= "<p>Para regreso al aeropuerto, se tiene un tiempo de tolerancia de espera de 15 minutos despu¨¦s de su horario de PickUp. Despu¨¦s de ese tiempo si requiere que se le siga esperando, tendr¨¢ costo adicional de 20 dlls la hora o fracci¨®n de espera. Si no quiere que esperemos despu¨¦s del tiempo de 15 minutos nos retiraremos dando NO SHOW en el servicio.</p><br>";
