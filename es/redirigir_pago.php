...
//	$contenido_correo.= "<img src='https://taxiaeropuertodecancun.com/images/welcome.jpg' style='width:100%;'><br>";
...
//	$contenido_correo.= "Zip code: ".$codigo_postal."<br><br>";
	...
	$contenido_correo.="<p><b>Porfavor recuerde pagaren efectivo con USD o en peso Mexicano al momento de su llegada con nuestro operador.</b><br>
	 ...
	 $contenido_correo.= "<img src='https://taxiaeropuertodecancun.com/images/avisos.jpg' style='width:100%;'>";
	 
	  $contenido_correo.= "<img src='https://taxiaeropuertodecancun.com/images/politica.jpg' style='width:100%;'>";
	 ...
	 $contenido_correo.= "<p style='border: 4px solid #3e9efe; background-color:#33A5FF; color: white; font-family: arial,helvetica; font-size: 26px; font-weight: bold;text-align: left;'>INFO.IMPORTANTE </p>";
	  ...
	  $contenido_correo.= "<img src='https://taxiaeropuertodecancun.com/images/llegadacancun.jpg' style='width:100%;'>";
	...
	$contenido_correo.= "<hr style= 'border: 4px solid #3e9efe ' width:100%;  />" ;
		...
		//mail("contac@cancuntransportation.com.mx",utf8_decode("Taxiaeropuertodecancun Ticket Reservation"),$contenido_correo,$header);
				...
				<div class="three-fourth">
					<form class="box readonly">
						...
						if(count($extras) > 0){
							...
							<h3>Extras: <?php echo $suma_precio.",00 MXN" ?></h3><br>
							<?php
						}
						?>
						
						
						<h3>TOTAL: <?php echo $precio+$suma_precio; ?>,00 MXN</h3>
