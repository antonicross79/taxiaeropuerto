...
for ($i=0; $i < count($id_extra) ; $i++) { 
	if(strlen($extra_ida[$i]) != 0 ||  strlen($extra_retorno[$i]) != 0){
		...
		$extras[] = ["id"=>$id_extra[$i],"ida"=>$t_extra_ida,"retorno"=>$t_extra_retorno,"precios"=>$extra_precios];
	}
}
...
<!-- Header -->
	...
	<main class="main" role="main">
		...
		<div class="full-width content container-fluid">
					...
					<p>Asegúrese de completar todos los campos obligatorios en el momento de la reserva. Esta información es imprescindible para garantizar un viaje sin problemas.<br />Todos los campos son requeridos.</p>
				</div>
		  	...
		  	<div class="col-xs-12 col-md-9 input-shadow">
				<form action="booking-step2.php" method="POST" name="formulario" id="formulario">
				 <div class="form-row">
				    ...
				    <label for="n_persona" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Nombres y Apellidos</label>
  ...
  <path d="M16 11l2 2l4 -4" /></svg></div>
				  ...
				  <div class="input-group col-xs-12 col-md-6">
				  	<label for="t_persona"  class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Telefono</label>
				  	<div class="input-group-prepend">
		  		 ...
		  		 <div class="form-row">
					  ...
					  <div class="input-group col-xs-12 col-md-6">
					    <label for="e_persona2" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Confirmar correo</label>
					    <div class="input-group-prepend">
						  <div class="input-group-text">
						  	<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00abfb" fill="none" stroke-linecap="round" stroke-linejoin="round">
							  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
				 ...
				 <div class="form-row">
				 	<div class="input-group mb-3 col-xs-12 col-md-6">
						<label for="flying_from" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Volando desde</label>
					  <div class="input-group-prepend">
					    <label class="input-group-text" for="inputGroupSelect01"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00abfb" fill="none" stroke-linecap="round" stroke-linejoin="round">
						  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
						  <polyline points="3 7 9 4 15 7 21 4 21 17 15 20 9 17 3 20 3 7" />
					  ...
					  <select class="form-control" id="flying_from" name="flying_from" placeholder="" required=""></select>
					</div>
					  <div class="input-group col-xs-12 col-md-6">
					  ...
					  <div class="input-group col-xs-12 col-md-6">
					    ...
					    <input type="text" class="form-control" id="flight_number" name="flight_number" placeholder="123">
					  </div>
					  <div class="input-group mb-3 col-xs-3 col-md-3">
							<label for="pickup_hour" class="pl-0 col-xs-12 col-md-12 mb-0 pb-2 mt-2">Tiempo de recogida del hotel</label>
						  <div class="input-group-prepend">
						  ...
						  <select required="" class="form-control" name="pickup_hour" id="pickup_hour" style="height: auto;">
					    	<?php 
					    	$j = 0;
					    	for ($i=0; $i < 24; $i++) { 
					    		if($i > 12){
					...
					<div class="input-group mb-3 col-xs-3 col-md-3">
						  ...
						  <select required="" class="form-control" name="pickup_minute" id="pickup_minute" style="height: auto;">
					    	<?php 
					    	for ($i=0; $i < 60; $i++) { 
					    		?>
