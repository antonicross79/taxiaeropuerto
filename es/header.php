...
<nav class="navbar navbar-expand-lg navbar-light bg-light d-md-none">
			  ...
			  <div class="collapse navbar-collapse" id="navbarNav">
			    <ul class="navbar-nav">
			      ...
			      <li class="nav-item">
			        <a class="nav-link disabled" href="contact.php">Contacto</a>
			      </li>
		...
		<header class="header d-none d-lg-block" role="banner">
			<div class="wrap">
				...
				<nav role="navigation" class="main-nav">
					...
					<li><a href="service.php" title="Services">Servicios</a></li>
					
					<!-- <li><a href="faq.php" title="faq">FAQ</a></li> -->
						
					
						<li><a href="contact.php" title="Contact">Contacto</a></li>
						
						
								<li><a href="#" title="idioma">Idioma</a>
						
						
                    <ul>		
						    <li><a href="index.php" title="Espanol">Espanol</a></li>
