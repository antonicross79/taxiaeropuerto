...
elseif ($tipo_de_pago == 'DIRECTO') {
	...
	$contenido_correo= '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
      ...
      $contenido_correo.='<img src="https://taxiaeropuertodecancun.com/images/logocancuntransportation.jpg" width="150" height="60" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
		...
		<div class="">
		<span>Your confirmation code is: <b>CT0000000'.$row['MAX(id_reservacion)'].'</b></span>
		...
		<table class="alert alert-success " border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; width: 100%; border: 0;">
		  ...
		  PAID IN CASH<br>
		  <b>Please REMEMBER to pay in cash with MXN OR USD <br>at you Arrival to our Driver</b>
		</div>
		      </td>
		    </tr>
		  </tbody>
